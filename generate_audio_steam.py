...
SCRIPT_FILE = os.path.join(BASE_DIR, "script_steam_long.md")
AUDIO_OUTPUT = os.path.join(BASE_DIR, "audio_steam_long.mp3")
...
def text_to_ssml(text, voice="es-MX-JorgeNeural", rate="+0%"):
    ...
    # Avoid matching decimal numbers (e.g. 10.0 or 30%) by matching punctuation followed by space or end of string.
...
async def generate_ssml_audio():
    print("====================================================")
    print("SSML TTS Voice Generator for Steam Video Essay")
    print("====================================================")
    
    print("Extracting Steam long locution...")

...
SHORTS_DATA = {
    1: {"bg": "onedrive_ref_1", "title": "¿Por qué odian a OneDrive?", "music": "Cipher2.mp3"},
    2: {"bg": "onedrive_ref_4", "title": "El Truco con Google", "music": "Scheming Weasel.mp3"},
    3: {"bg": "onedrive_ref_6", "title": "La Traición de Microsoft", "music": "Clash Defiant.mp3"},
    4: {"bg": "onedrive_ref_2", "title": "El Aviso que Molesta", "music": "Sneaky Snitch.mp3"},
    5: {"bg": "onedrive_ref_3", "title": "Google Drive vs OneDrive", "music": "Cipher2.mp3"},
    6: {"bg": "onedrive_ref_7", "title": "Errores de Sincronización", "music": "Volatile Reaction.mp3"},
    7: {"bg": "onedrive_ref_9", "title": "Microsoft vs Google", "music": "Moorland.mp3"}
}
                    ...
                    if "Audio (Voz en off)" in line:
                        for j in range(i+1, min(i+5, len(lines))):
                            ...
                            if next_line.startswith('"') and next_line.endswith('"'):
                                # Strip any hashtags from speech text
...
def draw_vertical_frame(width, height, words, title, font_sub, font_title, font_sub_bold, blurred_bg_img, progress, vignette_img=None, effect_type="zoom_in"):
    ...
    brand_top = 100
    draw_img.rounded_rectangle([brand_left, brand_top, brand_left + brand_w, brand_top + brand_h], radius=18, fill=(12, 18, 32, 175), outline=(56, 189, 248, 90), width=2)
    ...
    draw_img.rounded_rectangle([box_left, box_top, box_right, box_bottom], radius=24, fill=(12, 18, 32, 155), outline=(56, 189, 248, 60), width=2)
...
def compile_shorts():
    ...
    print("\n====================================================")
    print("DOMINUSBABEL ONEDRIVE VERTICAL SHORTS COMPILER")
    print("====================================================\n")

...
ESSAYS_DATA = {
    "onedrive_essay_1": {
        ...
        "badge": "TECNOLOGÍA 💻",
        "music": "Cipher2.mp3",
        "bg_screenshots": ["onedrive_ref_1", "onedrive_ref_2", "onedrive_ref_3", "onedrive_ref_4", "onedrive_ref_6", "onedrive_ref_7", "onedrive_ref_9"],
        "chapters": {
            1: {"subtitle": "Presente en Todas Partes", "badge": "WINDOWS 💻", "bullets": ["Integración nativa en Windows 11", "Presencia en Explorador de Archivos", "Notificaciones constantes de respaldo"]},
            2: {"subtitle": "La Paradoja Técnica", "badge": "RENDIMIENTO ⚙️", "bullets": ["Velocidades de subida superiores", "Incluido con la suscripción M365", "Copias de seguridad del sistema"]},
            3: {"subtitle": "El Error de la Intrusividad", "badge": "INTRUSIVIDAD ⚠️", "bullets": ["Alertas de espacio casi lleno", "Sincronización automática no deseada", "Carpetas movidas sin permiso"]},
            4: {"subtitle": "La Estrategia Silenciosa de Google", "badge": "ECOSISTEMA 🎓", "bullets": ["Captura de estudiantes con Chromebooks", "Ecosistema de Google Classroom", "Simplicidad en el navegador web"]},
            5: {"subtitle": "El Factor Confianza", "badge": "CONFIANZA 📉", "bullets": ["Eliminación del espacio ilimitado en 2015", "Reducción de cuotas gratuitas", "Cambios repentinos de condiciones"]},
            6: {"subtitle": "Fallos de Sincronización y Archivos Duplicados", "badge": "ERRORES 🛠️", "bullets": ["Errores de conflicto de guardado", "Iconos de estado confusos", "Archivos duplicados con nombre de equipo"]},
            7: {"subtitle": "Lecciones del Mercado de Software", "badge": "LECCIÓN 💡", "bullets": ["La experiencia de usuario es clave", "El respeto por la autonomía digital", "Por qué el mejor producto no siempre gana"]}
        }
    }
}
...
def draw_horizontal_frame(draw, width, height, title, subtitle, bullets, badge, font_title, font_sub, font_badge, blurred_bg_img, progress, vignette_img=None, effect_type="zoom_in"):
    ...
    # Sky blue borders for OneDrive tech theme
    draw_img.rounded_rectangle([panel_left, panel_top, panel_right, panel_bottom], radius=24, fill=(12, 18, 32, 175), outline=(56, 189, 248, 70), width=3)
    draw_img.rounded_rectangle([panel_left - 4, panel_top - 4, panel_right + 4, panel_bottom + 4], radius=28, fill=(0, 0, 0, 0), outline=(56, 189, 248, 20), width=2)
    ...
    # Divider line
    draw_img.line([panel_left + 80, panel_top + 220, panel_right - 80, panel_top + 220], fill=(56, 189, 248, 50), width=2)
    ...
    draw_progress_bar(draw_img, bar_x, bar_y, bar_w, 8, progress, color=(56, 189, 248, 220))
    
    return img_bg

def compile_essays():
    script_path = os.path.join(BASE_DIR, "scripts_onedrive_campaign.md")
    
    print("\n====================================================")
    print("DOMINUSBABEL ONEDRIVE VIDEO ESSAYS COMPILER")
    print("====================================================\n")

...
NEW_GAMES = [
    {"name": "Gates of Hell", "appid": 400750, "prefix": "gates_of_hell"},
    {"name": "Chaosbane", "appid": 774241, "prefix": "chaosbane"}
]
...
def main():
    print("====================================================")
    print("Starting Asset Collection Script for Gates of Hell & Chaosbane")
    print("====================================================")
    ...
    for game in NEW_GAMES:
        ...
        capsule_filename = f"{prefix}_capsule.jpg"
        ...
        # 2. Download trailer
        trailer_filename = f"{prefix}_trailer.mp4"

...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_onedrive_campaign.md")
...
def parse_scripts(file_path):
    ...
    essays = {}
    essay_parts = content.split('### 📽️ Ensayo 1: La Paradoja de OneDrive: Cómo Microsoft Arruinó su Mejor Producto')
            ...
            for i, line in enumerate(lines):
                if "Audio (Voz en off):" in line:
                    ...
                    if audio_text:
                        ...
                        break
        essays["onedrive_essay_1"] = " ".join(chapter_audios)
                    ...
                    if "Audio (Voz en off)" in line:
                        for j in range(i+1, min(i+5, len(lines))):
                            ...
                            if next_line.startswith('"') and next_line.endswith('"'):
                                shorts[f"onedrive_short_{idx}"] = clean_text(next_line)
                                break
...
async def main():
    print("====================================================")
    print("TTS Voice Generator for OneDrive Campaign")
    print("====================================================\n")
    ...
    print("Running neural voice synthesis for 8 items asynchronously...")
    tasks = []

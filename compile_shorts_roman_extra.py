...
EMPERORS = ["augusto", "trajano", "aureliano", "constantino", "mayoriano", "justiniano"]

SHORTS_DATA = {
    # Augusto
    "roman_extra_augusto_1": {"title": "EL FIN DE CLEOPATRA", "badge": "ACTIO 🌊", "bg_idx": 0, "music": "Rites.mp3"},
    "roman_extra_augusto_2": {"title": "LA HIJA EXILIADA", "badge": "ESCÁNDALO 💔", "bg_idx": 0, "music": "Rites.mp3"},
    "roman_extra_augusto_3": {"title": "LEGIONES PERDIDAS", "badge": "TRAGEDIA 💀", "bg_idx": 0, "music": "Rites.mp3"},
    # Trajano
    "roman_extra_trajano_1": {"title": "EL FIN DE DECÉBALO", "badge": "GUERRA 🛡", "bg_idx": 1, "music": "Volatile Reaction.mp3"},
    "roman_extra_trajano_2": {"title": "LA CAÍDA DE TRAJANO", "badge": "TRAGEDIA 💥", "bg_idx": 1, "music": "Volatile Reaction.mp3"},
    "roman_extra_trajano_3": {"title": "EL BOTÍN DE ORO", "badge": "RIQUEZA 💸", "bg_idx": 1, "music": "Volatile Reaction.mp3"},
    # Aureliano
    "roman_extra_aureliano_1": {"title": "LA REINA CAPTURADA", "badge": "PALMIRA 👑", "bg_idx": 2, "music": "Clash Defiant.mp3"},
    "roman_extra_aureliano_2": {"title": "ASESINATO A TRAICIÓN", "badge": "COMPLOT ☠", "bg_idx": 2, "music": "Clash Defiant.mp3"},
    "roman_extra_aureliano_3": {"title": "LA MASACRE DE LA CECA", "badge": "REFORMA 🏛", "bg_idx": 2, "music": "Clash Defiant.mp3"},
    # Constantino
    "roman_extra_constantino_1": {"title": "EL MONOGRAMA CELESTE", "badge": "MILVIO ⚔", "bg_idx": 3, "music": "Rites.mp3"},
    "roman_extra_constantino_2": {"title": "EL HIJO EJECUTADO", "badge": "TRAGEDIA 💔", "bg_idx": 3, "music": "Rites.mp3"},
    "roman_extra_constantino_3": {"title": "LA EMERATRIZ AHOGADA", "badge": "ASESINATO 💧", "bg_idx": 3, "music": "Rites.mp3"},
    # Mayoriano
    "roman_extra_mayoriano_1": {"title": "LA ÚLTIMA RECONQUISTA", "badge": "MILAGRO ⚔", "bg_idx": 4, "music": "Severe Tire Damage.mp3"},
    "roman_extra_mayoriano_2": {"title": "LA FLOTA TRAICIONADA", "badge": "TRAGEDIA 🔥", "bg_idx": 4, "music": "Severe Tire Damage.mp3"},
    "roman_extra_mayoriano_3": {"title": "EL FIN DEL HÉROE", "badge": "RICIMERO 🗡", "bg_idx": 4, "music": "Severe Tire Damage.mp3"},
    # Justiniano
    "roman_extra_justiniano_1": {"title": "LA VENGANZA DE ROMA", "badge": "BELISARIO ⚔", "bg_idx": 5, "music": "Volatile Reaction.mp3"},
    "roman_extra_justiniano_2": {"title": "MASACRE DE NIKA", "badge": "TRAGEDIA 💀", "bg_idx": 5, "music": "Volatile Reaction.mp3"},
    "roman_extra_justiniano_3": {"title": "LA EMPERATRIZ DE HIERRO", "badge": "TEODORA 👑", "bg_idx": 5, "music": "Volatile Reaction.mp3"}
}
...
def draw_vertical_short_frame(draw, width, height, title, badge, current_words, font_title, font_sub, font_badge, font_caption_active, font_caption_side, base_img, progress, effect_type="zoom_in", frame_idx=0):
    ...
    header_y = 120
    draw_img.text((width // 2, header_y), "HISTORIAS DE LA ROMA IMPERIAL", font=font_sub, fill=(56, 189, 248, 255), anchor="mm")
...
def compile_extra_shorts():
    script_path = os.path.join(BASE_DIR, "scripts_shorts_roman_extra.md")
    
    print("\n====================================================")
    print("KINESIO SHORTS COMPILER: ROMAN EXTRA STORIES")
    print("====================================================\n")
    ...
    for idx, (key, info) in enumerate(SHORTS_DATA.items()):
        ...
        print(f"Compiling Extra Short: {key}...")
        ...
        bg_path = os.path.join(SCREENSHOTS_DIR, f"roman_screenshot_{info['bg_idx']}.jpg")
        ...
        if os.path.exists(output_path) and os.path.getsize(output_path) > 0:
            print(f"  [SUCCESS] Extra Short generated: {output_path}")
        else:
            print(f"  [FAILED] Compile failed for {key}")

if __name__ == "__main__":
    compile_extra_shorts()

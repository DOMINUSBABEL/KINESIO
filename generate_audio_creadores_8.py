...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_8_shorts_creadores_crisis.md")

SHORTS_KEYS = [f"creadores_short_{i}" for i in range(1, 9)]
...
async def main():
    print("====================================================")
    print("TTS Neural Voice Generator: 8 Shorts Crisis de Creadores")

...
SHORTS_DATA = [
    {
        ...
        "desc": "El Cofre Samurái Oculto",
        "card": {
            "header": "DETALLES Y CURIOSIDADES",
            "bullets": [
                "📍 Cofre oculto en Rivacheg",
                "🛡️ Armadura extraña (+Arma)",
                "💰 100% Gratis al inicio"
            ]
        }
    },
    {
        "key": "warband_short_2",
        "title": "MOUNT & BLADE: WARBAND",
        "desc": "El Colapso de Calradia",
        "card": {
            "header": "HISTORIA DE CALRADIA",
            "bullets": [
                "🏛️ Inspiración Bizantina",
                "⚔️ Caída del gran Imperio",
                "👑 6 Facciones en guerra"
            ]
        }
    },
    {
        "key": "warband_short_3",
        "title": "MOUNT & BLADE: WARBAND",
        "desc": "Lanza Acoplada y Velocidad",
        "card": {
            "header": "CONSEJOS DE COMBATE",
            "bullets": [
                "🐎 Carga a máxima velocidad",
                "🎯 Daño inercial automático",
                "💥 >300 puntos de daño"
            ]
        }
    },
    {
        "key": "warband_short_4",
        "title": "MOUNT & BLADE: WARBAND",
        "desc": "El Arte del Bloqueo Manual",
        "card": {
            "header": "CONSEJOS DE COMBATE",
            "bullets": [
                "🛡️ Dirección del cursor",
                "⚔️ Reaccionar al oponente",
                "⚡ Contraataque veloz"
            ]
        }
    },
    {
        "key": "warband_short_5",
        "title": "MOUNT & BLADE: WARBAND",
        "desc": "Formaciones Tácticas",
        "card": {
            "header": "TÁCTICAS DE BATALLA",
            "bullets": [
                "📐 Teclas numéricas (1-3)",
                "⛰️ Posición en colinas (F1-F3)",
                "🐎 Flanqueo por retaguardia"
            ]
        }
    }
]

...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_15_shorts_rts_roma_2026.md")

SHORTS_KEYS = [f"rts_roma_short_{i}" for i in range(1, 16)]
...
async def main():
    print("====================================================")
    print("TTS Neural Voice Generator: 15 Shorts RTS 2026 & Roma Histórica")

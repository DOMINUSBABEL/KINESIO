...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_16_shorts_justiniano_belisario.md")

SHORTS_KEYS = [f"justiniano_belisario_short_{i}" for i in range(1, 17)]
...
async def main():
    print("====================================================")
    print("TTS Neural Voice Generator: 16 Shorts Justiniano & Belisario")

...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_shorts_roman_emperors.md")

SHORTS_KEYS = [f"roman_short_{i}" for i in range(1, 7)]
...
async def main():
    print("====================================================")
    print("TTS Voice Generator for Roman Emperors Shorts")
    print("====================================================")

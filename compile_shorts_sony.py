...
SHORTS_DATA = {
    "sony_short_1": {"title": "EL IMPUESTO OCULTO", "badge": "PS5 PRO 🎮", "bg_idx": 0},
    "sony_short_2": {"title": "NO ERES DUEÑO DE NADA", "badge": "LICENCIAS ⚖", "bg_idx": 1},
    "sony_short_3": {"title": "LA LEYENDA BORRADA", "badge": "SILENT HILLS 🏛", "bg_idx": 2},
    "sony_short_4": {"title": "EL FIN DEL MERCADO USADO", "badge": "MONOPOLIO 💸", "bg_idx": 3},
    "sony_short_5": {"title": "COMPRASTE UN JUEGO MUERTO", "badge": "SERVIDORES 💥", "bg_idx": 1},
    "sony_short_6": {"title": "LA RESISTENCIA FÍSICA", "badge": "TU DERECHO 👑", "bg_idx": 4}
}
...
def draw_vertical_short_frame(draw, width, height, title, badge, current_words, font_title, font_sub, font_badge, font_caption_active, font_caption_side, base_img, progress, effect_type="zoom_in", frame_idx=0):
    ...
    header_y = 120
    draw_img.text((width // 2, header_y), "PLAYSTATION Y EL FORMATO FÍSICO", font=font_sub, fill=(56, 189, 248, 255), anchor="mm")
...
def compile_sony_shorts():
    script_path = os.path.join(BASE_DIR, "scripts_shorts_sony.md")
    
    print("\n====================================================")
    print("KINESIO SHORTS COMPILER: SONY PHYSICAL MEDIA SERIES")
    print("====================================================\n")
    ...
    for idx, (key, info) in enumerate(SHORTS_DATA.items()):
        ...
        bg_path = os.path.join(SCREENSHOTS_DIR, f"sony_screenshot_{info['bg_idx']}.jpg")
        ...
        bg_music_path = os.path.join(MUSIC_DIR, "Clash Defiant.mp3")

...
SCRIPT_FILE = os.path.join(BASE_DIR, "scripts_shorts_roman_extra.md")

EMPERORS = ["augusto", "trajano", "aureliano", "constantino", "mayoriano", "justiniano"]
SHORTS_KEYS = []
for emp in EMPERORS:
    for i in range(1, 4):
        SHORTS_KEYS.append(f"roman_extra_{emp}_{i}")
...
async def main():
    print("====================================================")
    print("TTS Voice Generator for Roman Extra Shorts")
    print("====================================================")
    ...
    print(f"\n====================================================")
    print(f"Extra Shorts TTS Generation Complete: {successful}/{len(tasks)} files successfully generated")
    print("====================================================")

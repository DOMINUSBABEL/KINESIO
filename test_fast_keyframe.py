...
output_path = os.path.join(PROJECT_DIR, "test_fast_keyframe.mp4")
...
filter_complex = f"{video_filter};[0:a]volume=1.0[a1];[1:a]volume=0.07[a2];[a1][a2]amix=inputs=2:duration=first[a]"

...
SHORTS_DATA = {
    "roman_short_1": {
        "title": "AUGUSTO: EL PRINCEPS",
        "badge": "SIGLO I A.C./D.C. 🏛"
    },
    "roman_short_2": {
        "title": "TRAJANO: EL OPTIMUS",
        "badge": "SIGLO II D.C. ⚔"
    },
    "roman_short_3": {
        "title": "AURELIANO: RESTAURADOR",
        "badge": "SIGLO III D.C. 🛡"
    },
    "roman_short_4": {
        "title": "CONSTANTINO: EL VISIONARIO",
        "badge": "SIGLO IV D.C. ✝"
    },
    "roman_short_5": {
        "title": "MAYORIANO: EL TRÁGICO",
        "badge": "SIGLO V D.C. 🕯"
    },
    "roman_short_6": {
        "title": "JUSTINIANO: EL RECONQUISTADOR",
        "badge": "SIGLO VI D.C. 📜"
    }
}
...
def draw_vertical_short_frame(draw, width, height, title, badge, current_words, font_title, font_sub, font_badge, font_caption_active, font_caption_side, base_img, progress, effect_type="zoom_in", frame_idx=0):
    ...
    header_y = 120
    draw_img.text((width // 2, header_y), "BIOGRAFÍA: EMPERADORES ROMANOS", font=font_sub, fill=(56, 189, 248, 255), anchor="mm")
...
def compile_roman_shorts():
    script_path = os.path.join(BASE_DIR, "scripts_shorts_roman_emperors.md")
    
    print("\n====================================================")
    print("KINESIO SHORTS COMPILER: ROMAN EMPERORS SERIES")
    print("====================================================\n")
